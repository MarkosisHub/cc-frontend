...
const ProductScreen = () => {
  ...
  if (prod === "all products") {
    filteredProdcuts = products;
  } else {
    filteredProdcuts = products?.filter(
      (product) => product?.category?.trim()?.toLowerCase() === prod
    );
  }

  console.log("filteredProdcuts", filteredProdcuts);
        ...
        <div className="landscapeSection">
          <div className="landscapeWrapper">
            <div className="landscapeContent">
              {filteredProdcuts?.map((product, i) => {
                return (
                  <>
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(#00000089, #00000088), url(${
        ...
        <div className="productWrapper container">
          ...
          <div className="productContent">
            <div className="totalSortItems">
              <div className="total">
                <p>
                  Total: <span>{filteredProdcuts.length} items</span>
                </p>
              </div>
